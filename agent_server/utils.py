...
def _get_or_create_thread_id(request) -> str:
...
def init_mcp_client(workspace_client: WorkspaceClient) -> DatabricksMultiServerMCPClient:
    ...
    return DatabricksMultiServerMCPClient(
        [
            ...
            # Genie: cancer incidence analytics
            DatabricksMCPServer(
                name="genie-cancer-incidence",
                url=f"{host_name}/api/2.0/mcp/genie/01f117bb5fff15c58a5541490e9d6660",
                workspace_client=workspace_client,
            ),
            # Genie: clinical trials analytics
            DatabricksMCPServer(
                name="genie-clinical-trials",
